-- Fix trigger mappings for activity detail fields
-- Use this if 20260223_add_activities_image_url.sql was already applied
-- and instructions/materials_needed/benefits stopped persisting.
...
BEGIN
  INSERT INTO activities.activities (
    ...
    status, location, equipment_required,
    materials_needed, instructions, benefits,
  ...
  VALUES (
    ...
    NEW.status, NEW.location, NEW.equipment_required,
    NEW.materials_needed, NEW.instructions, NEW.benefits,
    NEW.image_url, NEW.created_by
  )
